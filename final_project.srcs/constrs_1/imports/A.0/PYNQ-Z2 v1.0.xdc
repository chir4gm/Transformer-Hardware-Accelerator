...
#Crypto SDA 
# PS Clock and Reset
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { FIXED_IO_ps_clk }]
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { FIXED_IO_ps_porb }]
set_property -dict { PACKAGE_PIN Y11   IOSTANDARD LVCMOS33 } [get_ports { FIXED_IO_ps_srstb }]

# PS MIO and DDR
set_property IOSTANDARD LVCMOS33 [get_ports FIXED_IO_mio*]
set_property IOSTANDARD SSTL15 [get_ports DDR_*]
set_property SLEW FAST [get_ports DDR_*]

# PS Clock generation
create_clock -period 10.000 -name clk_fpga_0 [get_pins "processing_system7_0/FCLK_CLK0"]

# Optional: Set false paths for asynchronous reset signals
set_false_path -from [get_pins processing_system7_0/ps_por_b] -to [get_pins {*_i/proc_sys_reset_0/*/PRE}]
set_false_path -from [get_pins processing_system7_0/FCLK_RESET0_N] -to [get_pins {*_i/proc_sys_reset_0/*/PRE}]

# XADC GND/VCC
set_property -dict { PACKAGE_PIN N10   IOSTANDARD ANALOG } [get_ports Vp_Vn_v_p]
set_property -dict { PACKAGE_PIN P10   IOSTANDARD ANALOG } [get_ports Vp_Vn_v_n]

# XADC Auxiliary analog inputs
set_property -dict { PACKAGE_PIN J10   IOSTANDARD ANALOG } [get_ports Vaux0_v_p]
set_property -dict { PACKAGE_PIN J11   IOSTANDARD ANALOG } [get_ports Vaux0_v_n]
set_property -dict { PACKAGE_PIN K9    IOSTANDARD ANALOG } [get_ports Vaux8_v_p]
set_property -dict { PACKAGE_PIN L10   IOSTANDARD ANALOG } [get_ports Vaux8_v_n]
